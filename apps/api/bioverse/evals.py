...
RED_FLAG_CASES: list[Case] = [
    ...
    Case(8046, "My heart is racing and I feel uneasy", "screen", "screen", topic="chest", known_gap=True,
    ...
    Case(8070, "I feel like I can't go on anymore and there's no point living", "tricky", "crisis",
         known_gap=True,
         note="Indirect suicidal ideation without a listed phrase. Current rules return 'none'."),
    Case(8071, "I don't want to be here anymore", "tricky", "crisis", known_gap=True,
    ...
    Case(8073, "My baby is floppy and won't wake up properly", "tricky", "emergency", known_gap=True,
         note="Pediatric warning sign (docs/04 lists pediatric presentations). No pediatric rules yet."),
    Case(8074, "I'm 34 weeks pregnant and bleeding heavily", "tricky", "emergency", known_gap=True,
         note="Obstetric bleeding. The rule matches 'heavy bleeding', not 'bleeding heavily', and there are "
              "no obstetric rules yet."),
    Case(8075, "Stiff neck, high fever and a rash that doesn't fade", "tricky", "emergency", known_gap=True,
         note="Possible meningitis / sepsis. No sepsis rules yet."),
    Case(8076, "My arm is numb and my speech sounds weird", "tricky", "emergency", known_gap=True,
    ...
    Case(8078, "I can't stop shaking and it's hard to breathe", "tricky", "emergency", known_gap=True,
